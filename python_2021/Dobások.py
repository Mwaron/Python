...
dobasok = [0,0,0,0,0,0] #itt számoljuk melyik számot hányszor doktuk meg 
...
while ertek != "":
    ...
    ertek = input("Rendben. Most hanyast dobtál? (ha nincs több csak üss 
                ENTERt) ")
   
dobasok_szama = dobasok[0]+dobasok[1]+dobasok[2]
                +dobasok[3]+dobasok[4]+dobasok[5]
